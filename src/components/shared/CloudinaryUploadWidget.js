/*
  ...
  -----------------------
  Taken from this example project:
...
const CloudinaryUploadWidget = ({ children, onUpload }) => {
  ...
  function createWidget() {
    ...
    // This should be find since only TFAA Admin users will be able to upload images

    const options = {
      cloudName: process.env.GATSBY_CLOUDINARY_CLOUD_NAME,
      uploadPreset: process.env.GATSBY_CLOUDINARY_UPLOAD_PRESET,
    }
