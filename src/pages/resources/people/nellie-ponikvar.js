  ...
  <div>
    ...
    <div css={rootStyles}>
      <Container>
        ...
        <FuturaParagraph>
          Nellie Ponikvar is currently the Director of Fine Arts for the Socorro Independent School District and has served in this position since 2001. She is currently completing her thirty-ninth year in education. Her teaching career began as the Band Director for Canutillo Independent School District in 1971. Her band was the first El Paso area band to compete in UIL competition. Nellie also worked for the Ysleta Independent School District as a teacher, campus administrator and Interim Fine Arts Director.
        </FuturaParagraph>
        <FuturaParagraph>
        ...
        <FuturaParagraph>
          Over the past nine years, groups in Socorro all participate in UIL competitions. One of its bands has been selected to participate in the State Marching Contest four times and the first elementary program in the El Paso area has been selected to perform at the Texas Music Educators Association Conference.
        </FuturaParagraph>
        <FuturaParagraph>
        ...
        <FuturaParagraph>
          Her honors include, Teacher of Month and finalist for campus Teacher of the Year. She was recently selected as a National Federation of High School Music Association’s Outstanding Music Educator. In 2008-09 Nellie was selected as the “Texas Music Administrator of the Year” by the Texas Music Administrators Conference.
        </FuturaParagraph>
        <FuturaParagraph>
