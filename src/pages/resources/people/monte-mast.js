  ...
  <Layout location={location}>
    ...
    <div css={rootStyles}>
      <Container>
        ...
        <FuturaParagraph>
          Monte has given presentations on diverse topics including how to get a teaching job, standards based fine arts grading, instrument evaluation, student motivation, effective presentation techniques and marching band adjudication. Monte is a member of and/or has made presentations to the Texas Music Educators Association, Texas Music Administrators Conference, Texas Bandmasters Association, Texas Art Educators Association, the Midwest Clinic, and the Conn-Selmer Music Administration Collaborative as well as multiple individual ISD’s. He conducts the annual fine arts stipend survey for the Texas Music Administrators Conference and has done additional research on fine arts teacher certification trends in Texas.
        </FuturaParagraph>
        <FuturaParagraph>
