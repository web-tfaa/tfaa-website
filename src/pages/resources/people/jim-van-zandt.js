  ...
  <div>
    ...
    <div css={rootStyles}>
      <Container>
        ...
        <FuturaParagraph>
          Jim Van Zandt is in his tenth year as Director of Fine Arts for the Round Rock Independent School District. In this capacity, is involved with operations, curriculum, staff development, budget, and staffing for Music, Art, Theatre, and Dance. He is also actively involved with the structure and curriculum of the district’s Visual and Performing Arts Academies. As a part of his role, he is a constant advocate for the arts in education.
        </FuturaParagraph>
        <FuturaParagraph>
        ...
        <FuturaParagraph>
          Jim serves bands, choirs, and orchestras as the Executive Secretary for Music Region 26 of the Texas University Interscholastic League, which manages the state sponsored music competitions. He has also previously served as a member of the Technical Advisory Committee for UIL Music Activities.Professional Associations include the Texas Music Educators Association, Texas Art Educators Association, Texas Educational Theatre Association, Texas Dance Educators Association, Texas Bandmasters Association, Texas Music Administrators Conference, Texas Choral Directors Association, and Texas Orchestra Directors Association, and Phi Beta Mu International Bandmasters Fraternity.
        </FuturaParagraph>
        <FuturaParagraph>
