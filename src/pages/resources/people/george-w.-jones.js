  ...
  <div>
    ...
    <div css={rootStyles}>
      <Container>
        ...
        <FuturaParagraph>
          George W. Jones has served as the Director of Fine Arts for the Garland Independent School District since 1997. In this capacity, he oversees the daily operations, curriculum, staff development, budget, and staffing for Music, Art, Theatre Arts, Dance and Competitive Speech.  He is a constant advocate for the arts in education.
        </FuturaParagraph>
        <FuturaParagraph>
        ...
        <FuturaParagraph>
          In addition to his duties in the GISD, George has served as conductor of the Richardson Community Band since 1983. During his tenure as director of the band, the band has grown both in size and popularity. He instituted the band’s summer series, which has become a favorite summer activity for families across the Metroplex. In 2010, George was presented with the “Real Heroes Award” by the Richardson Coalition for his service as conductor of the RCB. In 2011, the Richardson Arts Alliance presented him with the “Lifetime Achievement Award.”
        </FuturaParagraph>
        <FuturaParagraph>
          George is married to Donna Jones, a teacher in the Garland ISD, and they have two children and one grandson.
        </FuturaParagraph>
      </Container>
    </div>
  </div>
