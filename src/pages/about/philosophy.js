      ...
      <Container>
        ...
        <Cards>
          <PhilosophyCard>
            ...
            <FuturaDiv>
              ...
              <ul>
                ...
                <li css={{ marginBottom: 0 }}>&quot;Buzzy&quot; Green, Band Representative</li>
          ...
          <PhilosophyCard>
            ...
            <FuturaParagraph>
              <span css={{ fontWeight: 600 }}>A.</span> TMAC is in complete support of and
              recommends that the integrity of the music and learning experience always remain the
              highest priority.
            </FuturaParagraph>
            <FuturaParagraph>
              <span css={{ fontWeight: 600 }}>B.</span> TMAC recommends that all Texas high school
            ...
            <FuturaParagraph>
              <span css={{ fontWeight: 600 }}>C.</span> TMAC commends the UIL for its ongoing
            ...
            <FuturaParagraph>
              <span css={{ fontWeight: 600 }}>D.</span> TMAC recommends and supports a continued
