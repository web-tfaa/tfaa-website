      ...
      <div className={classes.root}>
        <Container>
          ...
          <Box mb={3}>
            <FuturaAnchor
              download
              href="https://res.cloudinary.com/tmac/image/upload/v1629210484/TMAC_Bylaws_-_Updated_7-23-21.pdf"
          ...
          <section>
            <dl className={classes.paddingMedium}>
              ...
              <dd className={classes.paddingMedium}>
                ...
                <span className={classes.strong}>Texas Music Administrators Conference, Inc.</span>{' '}
          ...
          <section>
            <dl className={classes.paddingMedium}>
              ...
              <dd className={classes.paddingLarge}>
                The <em className={classes.strong}>Vice-President</em> will chair the Nominating
                Committee, the Recognitions Committee and any committees on special subjects as
                designated by the Board of Directors.
              </dd>
              <dd className={classes.paddingLarge}>
                The <em className={classes.strong}>Past President</em> will chair any committees on
                special subjects as designated by the Board of Directors.
              </dd>
              <dd className={classes.paddingLarge}>
                The <em className={classes.strong}>Secretary</em> shall be responsible for keeping
